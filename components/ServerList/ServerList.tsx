...
export default function ServerList() {
  ...
  return (
    <div className="bg-dark-gray h-full flex flex-col items-center">
      ...
      className="flex items-center justify-center rounded-icon bg-gray-700 p-2 my-2 text-2xl font-light h-12 w-12 text-white hover:bg-blue-900 hover:text-white hover:rounded-xl transition-all duration-200"
      >
